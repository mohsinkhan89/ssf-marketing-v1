<header class="site-header" id="top">
    <nav class="container nav-shell" aria-label="Main navigation">
        <a class="brand" href="{{ route('home') }}" aria-label="Markit home"><img class="brand-logo"
                src="{{ url($siteSetting?->logo_path ?? 'frontend/assets/images/logo/logo.png') }}" alt="Markit" /></a>
        ...
        <a class="button button-primary nav-cta" href="{{ route('contact-us') }}"><span>Get In Touch</span><lord-icon
